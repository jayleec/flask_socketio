...
from wilson.blueprints.user.decorators import anonymous_required
from wilson.blueprints.user.models import User
from wilson.blueprints.user.forms import (
    LoginForm,
...
@user.route('/settings/update_credentials', methods=['GET', f'POST'])
@login_required
